...
export function RoadmapSection() {
    ...
    return (
        <section
            id="how-it-works"
            ref={containerRef}
            className="relative w-full overflow-hidden bg-[#F4F7FC] py-24 sm:py-32"
        >
            <div className="mx-auto max-w-7xl px-6 lg:px-12">
                ...
                <div className="relative">
                    ...
                    <svg
                        className="pointer-events-none absolute bottom-0 left-2 top-0 z-0 h-full w-20 overflow-visible md:left-8 lg:left-12 lg:w-28"
                    ...
                    <div className="relative z-10 flex flex-col gap-24 py-10 md:gap-32">
                        {STAGES.map((stage, index) => {
                            ...
                            return (
                                <div
                                    ...
                                    className="pl-20 md:pl-32 lg:pl-48"
                                >
                                    <div className="slide-content grid grid-cols-1 items-center gap-12 lg:grid-cols-[0.8fr_1.2fr]">
                                        ...
                                        <div>
                                            ...
                                            <h3 className="text-3xl font-bold tracking-[-0.03em] text-[#0B1F3A] sm:text-4xl">
